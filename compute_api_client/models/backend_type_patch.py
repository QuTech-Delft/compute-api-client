...
class BackendTypePatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "infrastructure", "description", "image_id", "is_hardware", "supports_raw_data", "features", "default_compiler_config", "gateset", "topology", "nqubits", "default_number_of_shots", "max_number_of_shots", "enabled", "identifier", "protocol_version", "job_execution_time_limit", "batchjobs_per_queue_limit", "max_jobs_per_batch_job"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if batchjobs_per_queue_limit (nullable) is None
        # and model_fields_set contains the field
        if self.batchjobs_per_queue_limit is None and "batchjobs_per_queue_limit" in self.model_fields_set:
            _dict['batchjobs_per_queue_limit'] = None
