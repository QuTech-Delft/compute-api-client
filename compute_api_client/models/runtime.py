...
class Runtime(object):
    ...
    def __init__(self, name=None, location=None, runtime_type_id=None, status=None, last_heartbeat=None, authentication_hash=None, id=None, local_vars_configuration=None):  # noqa: E501
