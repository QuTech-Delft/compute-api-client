...
> PageAlgorithm read_algorithms_algorithms_get(search=search, page=page, size=size, id=id, project_id=project_id, type=type, shared=shared, link__isnull=link__isnull, link=link, name=name, sort_by=sort_by, latest=latest)
...
async with compute_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List algorithms
        api_response = await api_instance.read_algorithms_algorithms_get(search=search, page=page, size=size, id=id, project_id=project_id, type=type, shared=shared, link__isnull=link__isnull, link=link, name=name, sort_by=sort_by, latest=latest)
