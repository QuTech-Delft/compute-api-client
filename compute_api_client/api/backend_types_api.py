...
class BackendTypesApi:
    ...
    @validate_call
    async def read_backend_type_queue_backend_types_id_queue_get(
        self,
        id: StrictInt,
        user_only: Annotated[Optional[StrictBool], Field(description="By default, queue statistics include all users. If True, only calculates statistics for the current user.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param user_only: By default, queue statistics include all users. If True, only calculates statistics for the current user.
        :type user_only: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._read_backend_type_queue_backend_types_id_queue_get_serialize(
            id=id,
            user_only=user_only,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def read_backend_type_queue_backend_types_id_queue_get_with_http_info(
        self,
        id: StrictInt,
        user_only: Annotated[Optional[StrictBool], Field(description="By default, queue statistics include all users. If True, only calculates statistics for the current user.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def read_backend_type_queue_backend_types_id_queue_get_without_preload_content(
        self,
        id: StrictInt,
        user_only: Annotated[Optional[StrictBool], Field(description="By default, queue statistics include all users. If True, only calculates statistics for the current user.")] = None,
        _request_timeout: Union[
    ...
    def _read_backend_type_queue_backend_types_id_queue_get_serialize(
        self,
        id,
        user_only,
        _request_auth,
        ...
        if user_only is not None:
            ...
            _query_params.append(('user_only', user_only))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/backend_types/{id}/queue',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def read_backend_types_backend_types_get(
        ...
        :param batchjobs_per_queue_limit:
        :type batchjobs_per_queue_limit: int
    ...
    def _read_backend_types_backend_types_get_serialize(
        ...
        if batchjobs_per_queue_limit is not None:
            
            _query_params.append(('batchjobs_per_queue_limit', batchjobs_per_queue_limit))
