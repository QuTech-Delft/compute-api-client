...
class JobsApi:
    ...
    @validate_call
    async def get_job_logs_jobs_id_logs_get(
        self,
        id: StrictInt,
        start: Annotated[Optional[StrictInt], Field(description="Start timestamp(nanosec)")] = None,
        end: Annotated[Optional[StrictInt], Field(description="End timestamp(nanosec)")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Maximum number of logs per page")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param start: Start timestamp(nanosec)
        :type start: int
        :param end: End timestamp(nanosec)
        :type end: int
        ...
        _param = self._get_job_logs_jobs_id_logs_get_serialize(
            id=id,
            start=start,
            end=end,
            limit=limit,
    ...
    @validate_call
    async def get_job_logs_jobs_id_logs_get_with_http_info(
        self,
        id: StrictInt,
        start: Annotated[Optional[StrictInt], Field(description="Start timestamp(nanosec)")] = None,
        end: Annotated[Optional[StrictInt], Field(description="End timestamp(nanosec)")] = None,
    ...
    @validate_call
    async def get_job_logs_jobs_id_logs_get_without_preload_content(
        self,
        id: StrictInt,
        start: Annotated[Optional[StrictInt], Field(description="Start timestamp(nanosec)")] = None,
        end: Annotated[Optional[StrictInt], Field(description="End timestamp(nanosec)")] = None,
    ...
    def _get_job_logs_jobs_id_logs_get_serialize(
        self,
        id,
        start,
        end,
