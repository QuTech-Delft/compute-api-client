...
| _DrainModeApi_    | [**read_drain_mode_drain_mode_get**](compute_api_client/docs/DrainModeApi.md#read_drain_mode_drain_mode_get)                                                                 | **GET** /drain_mode                       | Retrieve drain mode statistics for all backendtypes |
| _DrainModeApi_    | [**update_drain_mode_drain_mode_patch**](compute_api_client/docs/DrainModeApi.md#update_drain_mode_drain_mode_patch)                                                         | **PATCH** /drain_mode                     | Enable drain mode for all backendtypes              |
...
- [DrainMode](compute_api_client/docs/DrainMode.md)
- [DrainModeIn](compute_api_client/docs/DrainModeIn.md)
...
- [Queue](compute_api_client/docs/Queue.md)
